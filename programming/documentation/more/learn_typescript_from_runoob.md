...
```typescript
/**
 *  number对象：let number1: number = 123;
 *  Number对象：let number2: Number = new Number(123);
**/
...
```typescript
/**
 *  string对象：let string1: string = 'hello';
 *  String对象：let string2: String = new String('hello');
**/
 ...
 *  Map对象：let map2: Map<string, number> = new Map([['Google', 1], ['Taobao', 2]]);
 *
 *  map.clear()：移除Map对象的键值对
 *  map.set()
 *  map.get()
