...
class PlacesOfInterset extends StatefulWidget {
  PlacesOfInterset({Key? key, required this.places}) : super(key: key);

  final List<Place> places;

  @override
  _PlacesOfIntersetState createState() => _PlacesOfIntersetState();
}
...
class _PlacesOfIntersetState extends State<PlacesOfInterset> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        selectedIconTheme:
            IconThemeData(color: Color.fromARGB(224, 91, 228, 121)),
        selectedItemColor: Color.fromARGB(224, 91, 228, 121),
  ...
  Widget _buildButtonSection() {
    final Color color = Color.fromARGB(225, 27, 98, 179);
